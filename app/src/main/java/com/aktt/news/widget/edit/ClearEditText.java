package com.aktt.news.widget.edit;
 ...
 * Description : 带清空功能的EditText-DrawableRight，监听焦点和输入值改变状态
 */
...
public class ClearEditText extends AppCompatEditText
  ...
  private void init() {
    ...
    if (mClearDrawable == null) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        mClearDrawable = getResources().getDrawable(R.drawable.btn_login_delete, null);
      } else {
  ...
  private void setDrawableRightightVisible(boolean visible) {
    ...
    setCompoundDrawables(getCompoundDrawables()[0], getCompoundDrawables()[1], drawableRight,
