...
public class VideoHelper {
  ...
  public static void initPlayer(final Context context, final StandardGSYVideoPlayer gsyVideoPlayer,
      String title, final OrientationUtils orientationUtils) {
  ...
  public void loadFirstFrame(Context context) {
    ...
    GlideApp.with(context)
        .setDefaultRequestOptions(
            new RequestOptions().frame(1000000).centerCrop().error(R.drawable.ic_empty_picture));
  }
