package com.chaoneng.ilooknews.library.loadandretry;
...
public class LoadingAndRetryManager {
    ...
    private void setupEmptyLayout(OnLoadingAndRetryListener listener,
    ...
    private void setupLoadingLayout(OnLoadingAndRetryListener listener,
            LoadingAndRetryLayout loadingAndRetryLayout) {
    ...
    private void setupRetryLayout(OnLoadingAndRetryListener listener,
            LoadingAndRetryLayout loadingAndRetryLayout) {
